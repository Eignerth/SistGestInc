            ...
            <div class="input-group">
                ...
                @can('Agregar Personal')
                    <span data-toggle="modal" data-target="#storepersonal">
                        <button class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="Agregar Personal"><i class="fas fa-plus-square"></i></button>
                    </span>    
                @endcan
            </div>
        </div>        
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><a wire:click.prevent="sortBy('ownemail')" role="button" href="#">
                        Email Personal
                        @include('includes._sort-icon',['field'=>'ownemail'])
                    </a></th>
                    <th><a wire:click.prevent="sortBy('possitions')" role="button" href="#">
                        Cargo
                        @include('includes._sort-icon',['field'=>'possitions'])
                    </a></th>
                    <th>Acciones</th>
                </tr>
            </thead>
