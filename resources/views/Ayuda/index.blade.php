...
<div>
    ...
    <img src="{{asset('img/help/dashboard.png')}}" class="card-img-bottom" alt="inicio">
      ...
      <div class="card">
        ...
        <img src="{{asset('img/help/administracion.png')}}" class="card-img-bottom" alt="mantenimiento">
        <div class="accordion" id="accordionExample">
          <div class="card">
            <div class="card-header" id="headingUno">
              <h2 class="mb-0">
                <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseUno" aria-expanded="false" aria-controls="collapseUno">
                  Empresa
                </button>
              </h2>
            </div>
                  ...
                  <div class="col-sm-6">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <img src="{{asset('img/help/empresa.png')}}" class="card-img-bottom" alt="inicio">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-6">
                          ...
                          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              ...
                              <div class="carousel-item">
                                ...
                                <img src="{{asset('img/help/CrearAreas.png')}}" class="d-block w-100" alt="crear">
                              </div>
                              <div class="carousel-item">
                                <h5 class="card-title">Editar Áreas</h5>
                                <p class="card-text">En esta opción, editaremos las áreas que hemos registrado.</p>
                                <img src="{{asset('img/help/EditarAreas.png')}}" class="d-block w-100" alt="editar">
                              </div>
                            </div>
                          ...
                          <div id="carouselExampleIndicator" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              ...
                              <div class="carousel-item">
                                ...
                                <img src="{{asset('img/help/agregarcargos.png')}}" class="d-block w-100" alt="crear">
                              </div>
                              <div class="carousel-item">
                                ...
                                <img src="{{asset('img/help/EditarCargos.png')}}" class="d-block w-100" alt="editar">
                              </div>
                            </div>
                          ...
                          <div id="carouselExampleIndicato" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                ...
                                <img src="{{asset('img/help/rolespermisos.png')}}" class="d-block w-100" alt="...">
                              </div>
                              <div class="carousel-item">
                              ...
                              <div class="carousel-item">
                                ...
                                <img src="{{asset('img/help/crearoles2.png')}}" class="d-block w-100" alt="editar">
                              </div>
                            </div>
