<div wire:ignore.self class="modal fade" id="commentticket" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="commenttickettittle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="commenttickettittle">Comentar</h5>
      </div>
