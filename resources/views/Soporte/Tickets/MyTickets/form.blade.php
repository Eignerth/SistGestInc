...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <select class="form-control" wire:model="serie" name="serie" aria-describedby="seriehelp">
            <option>Elige...</option>
    ...
    <div class="form-group col-md-6">
        ...
        <div class="input-group">
            <select class="form-control" wire:model="contacto" name="contacto" aria-describedby="contactohelp">
                <option>Elige...</option>
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" wire:model="clasificacion" name="clasificacion" aria-describedby="clasifhelp">
            <option>Elige...</option>
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" wire:model="canal" name="canal" aria-describedby="canalhelp">
            <option>Elige...</option>
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" wire:model="producto" name="producto" aria-describedby="productohelp">
            <option>Elige...</option>
    ...
    <div class="form-group col-md-6">
        ...
        <select class="form-control" wire:model="prioridad" name="prioridad" aria-describedby="prioridadhelp">
            <option>Elige...</option>
...
<div class="form-group ">
    ...
    <select class="form-control" wire:model="status" aria-describedby="statushelp">
        <option>Elige...</option>
...
<div class="form-group">
    ...
    <textarea class="form-control {{$errors->has('mensaje')?'is-invalid':''}}" wire:model="mensaje" cols="30" rows="4" placeholder="Descripción o Mensaje" aria-describedby="mensajehelp"></textarea>
    @error('mensaje')
        <div class="invalid-feedback"> {{$message}} </div>                        
    @enderror
</div>
...
{{--  <div class="form-group">
    ...
    <small id="passwordHelpBlock" class="form-text text-muted">
        Solo se aceptarán los siguientes formatos. pdf | docx | xlsx | pptx | jpg | png | jpeg    
    </small>
    @error('archivos.*') <div class="error">{{ $message }}</div> @enderror
